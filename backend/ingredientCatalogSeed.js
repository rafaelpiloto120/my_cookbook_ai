...
const CORE_INGREDIENT_CATALOG_SEED_ITEMS = [
  item("chicken_breast", "chicken breast", "protein", { calories: 165, protein: 31, carbs: 0, fat: 4, unit: "g" }, { quantity: 150, unit: "g" }, { en: ["chicken", "chicken breast", "grilled chicken", "skinless chicken breast", "boneless skinless chicken breast"], "pt-PT": ["frango", "peito de frango", "frango grelhado", "peitos de frango", "peito de frango sem pele", "peitos de frango desossados e sem pele"], "pt-BR": ["frango", "peito de frango", "frango grelhado", "peitos de frango", "peito de frango sem pele", "peitos de frango desossados e sem pele"], es: ["pollo", "pechuga de pollo", "pechugas de pollo", "pollo a la plancha"], fr: ["poulet", "blanc de poulet", "blancs de poulet", "filet de poulet", "filets de poulet", "poulet grille"], de: ["hahnchen", "hahnchenbrust", "huhnerbrust", "gegrilltes hahnchen"] }),
  ...
  item("beef", "beef", "protein", { calories: 250, protein: 26, carbs: 0, fat: 17, unit: "g" }, { quantity: 150, unit: "g" }, { en: ["beef", "beef strips", "steak", "minced beef", "ground beef"], "pt-PT": ["vaca", "carne de vaca", "bife", "carne picada", "carne moida"], "pt-BR": ["carne bovina", "bife", "carne", "carne moida", "carne picada"], es: ["ternera", "carne de res", "filete", "carne picada"], fr: ["boeuf", "steak", "boeuf hache"], de: ["rindfleisch", "steak", "hackfleisch"] }),
  ...
  item("tomato", "tomato", "vegetable", { calories: 18, protein: 0.9, carbs: 3.9, fat: 0.2, unit: "g" }, { quantity: 120, unit: "g" }, { en: ["tomato", "tomatoes", "chopped tomato", "canned tomato"], "pt-PT": ["tomate", "tomates", "tomate picado", "tomate enlatado", "tomate picado enlatado"], "pt-BR": ["tomate", "tomates", "tomate picado", "tomate enlatado", "tomate picado enlatado"], es: ["tomate", "tomates"], fr: ["tomate", "tomates"], de: ["tomate", "tomaten", "kirschtomaten"] }),
  ...
  item("bell_pepper", "bell pepper", "vegetable", { calories: 31, protein: 1, carbs: 6, fat: 0.3, unit: "g" }, { quantity: 100, unit: "g" }, { en: ["bell pepper", "pepper", "red bell pepper"], "pt-PT": ["pimento", "pimento vermelho"], "pt-BR": ["pimentao", "pimentao vermelho"], es: ["pimiento", "pimiento rojo"], fr: ["poivron", "poivron rouge"], de: ["paprika", "rote paprika"] }),
  ...
  item("olive_oil", "olive oil", "fat", { calories: 884, protein: 0, carbs: 0, fat: 100, unit: "g" }, { quantity: 14, unit: "g" }, { en: ["olive oil"], "pt-PT": ["azeite", "azeite de oliva"], "pt-BR": ["azeite de oliva", "azeite"], es: ["aceite de oliva"], fr: ["huile d olive"], de: ["olivenol"] }),
  ...
  item("tomato_sauce", "tomato sauce", "sauce", { calories: 29, protein: 1.4, carbs: 6, fat: 0.2, unit: "g" }, { quantity: 125, unit: "g" }, { en: ["tomato sauce", "pasta sauce"], "pt-PT": ["molho de tomate", "molho tomate"], "pt-BR": ["molho de tomate", "molho tomate"], es: ["salsa de tomate"], fr: ["sauce tomate"], de: ["tomatensosse"] }),
